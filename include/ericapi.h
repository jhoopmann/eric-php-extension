...
<H3> Dokumentation </H3>
Das Dokumentationspaket beinhaltet das <I>ERiC-Entwicklerhandbuch.pdf</I>, <I>ERiC-ESt-Tutorial.pdf</I>, <I>ERiC-Aenderungsdokumentation.pdf</I>, <I>Datenartversionmatrix.xml</I>, diese API-Referenz sowie die Dokumentation aller Feldkennungen, Plausibilitätsprüfungen, Schemata und Schnittstellenbeschreibungen. 
...
\n Die Änderungsdokumentation enthält die Änderungen der aktuell unterstützten ERiC Releases.
\n Die Datenartversionmatrix enthält eine Übersicht der datenartVersionen, die ERiC unterstützt. Einige API-Funktionen verwenden die <I>datenartVersion</I> als Parameter, weitere Informationen siehe ERiC-Entwicklerhandbuch.pdf, Kapitel <I>datenartVersion – Definition und Verwendung</I>.
...
\n Der Datentyp <B>char</B> zeigt an, wo UTF-8 kodierte Zeichenketten zu verwenden sind. Der Datentyp ::byteChar zeigt an, wo ASCII zu verwenden ist bzw. bei Pfadangaben das betriebssystemspezifische Encoding, siehe ERiC-Entwicklerhandbuch.pdf, Kapitel <I>Übergabe von Pfaden an ERiC API-Funktionen</I>.
\n Die erlaubte Zeichenmenge lässt sich dem Datentyp <I>BaseStringSType</I> aus dem ElsterBasisSchema <I>headerbasis_datentypen.xsd</I> der Schnittstellenbeschreibung entnehmen.
\n Bei der Eingabe von PINs sind nur Zeichen aus dem ASCII Zeichensatz, ohne Sonder- und Steuerzeichen, erlaubt, siehe <A HREF="http://de.wikipedia.org/wiki/ASCII">http://de.wikipedia.org/wiki/ASCII</a>.
**/
